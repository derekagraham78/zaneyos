...
workspace = name:Desktop1,monitor:HDMI-A-3,default:true,persistant:true
workspace = name:Desktop2,,monitor:HDMI-A-1,default:truepersistant:true
...
windowrulev2 = workspace name:7Misc, class:^(deluge)$
windowrulev2 = workspace name:7Misc, class:^(floorp)$
windowrulev2 = workspace name:6Chat, class:^(discord)$
windowrulev2 = workspace name:6Chat, class:^(Element)$
...
bind = ${modifier},1,workspace,1Web
bind = ${modifier},2,workspace,2Terms
bind = ${modifier},3,workspace,3Files
bind = ${modifier},4,workspace,4Editors
bind = ${modifier},5,workspace,5
bind = ${modifier},6,workspace,6Chat
bind = ${modifier},7,workspace,7Misc
...
bind = ${modifier}SHIFT,2,movetoworkspace,name:2Terms
bind = ${modifier}SHIFT,3,movetoworkspace,name:3Files
bind = ${modifier}SHIFT,4,movetoworkspace,name:4Editors
bind = ${modifier}SHIFT,5,movetoworkspace,5
bind = ${modifier}SHIFT,6,movetoworkspace,name:6Chat
bind = ${modifier}SHIFT,7,movetoworkspace,name:7Misc
