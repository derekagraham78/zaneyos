...
bind = ${modifier},1,workspace,1-Web
bind = ${modifier},2,workspace,2-Terms
bind = ${modifier},3,workspace,3-Files
bind = ${modifier},4,workspace,4-Editors
bind = ${modifier},5,workspace,5
bind = ${modifier},6,workspace,6-Chat
bind = ${modifier},7,workspace,7-Misc
