...
bind = ${modifier}SHIFT,1,movetoworkspace,1Web
bind = ${modifier}SHIFT,2,movetoworkspace,2Terms
bind = ${modifier}SHIFT,3,movetoworkspace,3Files
bind = ${modifier}SHIFT,4,movetoworkspace,4Editors
bind = ${modifier}SHIFT,5,movetoworkspace,5
bind = ${modifier}SHIFT,6,movetoworkspace,6Chat
bind = ${modifier}SHIFT,7,movetoworkspace,7Misc
